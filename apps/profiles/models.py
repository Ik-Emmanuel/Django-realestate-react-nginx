...
class Gender(models.TextChoices):
    MALE="Male", _("Male") #string representation is defined in tuple
    FEMALE="Female", _("Female")
    OTHER = "Other", _("Other")

class Profile(TimeStampedUUIDModel):
    user =  models.OneToOneField(User, related_name="profile", on_delete=models.CASCADE)
    phone_number = PhoneNumberField(verbose_name=_("Phone number"), max_length=30, default="+2341234343")
    about_me = models.TextField(verbose_name=_("About me"), default="About Yourself")
    ...
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False, help_text=_("Are you looking to selling a property?"))
